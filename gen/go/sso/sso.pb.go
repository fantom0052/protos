...
package fantom0052_sso_v1_ssov1
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token of the logged in the user
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // Indicates whether user is an admin
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x17, 0x66, 0x61, 0x6e, 0x74, 0x6f, 0x6d, 0x30, 0x30, 0x35, 0x32, 0x2e, 0x73, 0x73, 0x6f,
	0x2e, 0x76, 0x31, 0x2e, 0x73, 0x73, 0x6f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
